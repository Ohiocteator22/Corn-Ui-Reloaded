...
function Signals:Fire(name,...)
	...
	local signal = self._events[name]
...
-- ============================================================
-- DEFAULT CORNUI EVENTS
-- ============================================================

Signals:Create("ThemeChanged")

Signals:Create("WindowCreated")

Signals:Create("WindowDestroyed")

Signals:Create("WidgetCreated")

Signals:Create("ConfigChanged")

Signals:Create("PluginLoaded")

Signals:Create("PluginUnloaded")

Signals:Create("NotificationCreated")
