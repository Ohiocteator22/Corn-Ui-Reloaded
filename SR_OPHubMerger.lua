...
local ItemsTab = Window:CreateTab("Items", { Icon = "📦" })
local TeleportsTab = Window:CreateTab("Teleports", { Icon = "📍" })
local CombatTab = Window:CreateTab("Combat", { Icon = "⚔️" })
local BETATab = Window:CreateTab("BETA", { Icon = "🧪" })
local SafetyTab = Window:CreateTab("Safety", { Icon = "🛡️" })
